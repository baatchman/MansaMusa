...
class c_MAC_COLUMN_Assembly: public c_Base_Assembly
{
protected:
     
public:
     
     c_MAC_COLUMN_Assembly(c_Table_Handler * p_Tables, string p_Assembly_Name = "c_MAC_COLUMN Assembly", int p_AID = 0) : c_Base_Assembly(p_Tables, p_Assembly_Name, p_AID)
     {
          cout << "\n\t  c_MAC_COLUMN_Assembly() ~~Constructor";
