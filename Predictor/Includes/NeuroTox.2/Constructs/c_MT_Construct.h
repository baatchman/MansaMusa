...
class c_MT_Base_Construct: public c_Base_Construct
{
protected:
     ...
     c_MT_Base_Node_Network Node_Network;
...
public:
     ...
     void charge_Charging_Buffer_Output()
     {
     ...
     void gather_Charging_Buffer()
     {
          ...
          Charging_Buffer.gather(Filter_Charge, Charge_Precision);
     ...
     void charge(int p_Charging_Method = 0, int p_Tier = 0)
     {
          ...
          //cout << "\n\t Charging_All_Tiers->" << Construct_Name << " #Tiers->" << Current_Highest_Tier;
     ...
     void expand_CAN(int p_CAN_Count)
     {
          ...
          //Setup the array.
          CAN = new c_MT_Base_CAN * [p_CAN_Count];

          //Create the individual CANs and pass the node network to them.
          for (int cou_CAN=0;cou_CAN<CAN_Count;cou_CAN++)
          {
               CAN[cou_CAN] = new c_MT_Base_CAN(&Node_Network, &Charging_Buffer, Treetop_Table, &BenchMark);
          }
