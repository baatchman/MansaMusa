...
class c_Treetop_RC_State_Node_1D: public c_Base_Node_1D
{
private:
...
public:
     ...
     {
          cout << " -" << this << " RC->" << RC << " RC_LVL->" << RC_LVL << " NR:" << State.NR << " Tt->" << Treetop.I << " CID->" << U_CID << " Tier->" << Tier << " Index->" << Index;
     }
     
     string get_Type()
     {
          return "Treetop_RC_State_Node";
     }
