...
class c_Base_Node_1D
{
protected:
     
public:
     
     c_Base_Node_1D *** Axons;
     c_Base_Node_1D ** Dendrites;
     int Axon_Count[2];
     //int Dendrite_Count[2];
     
     int Index;
     
     c_Base_Node_1D * Previous;
     c_Base_Node_1D * Next;
     ...
     void add_Axon(int p_Leg, c_Base_Node_1D * p_Node)
     {
          ...
          { 
               ...
               Axons[p_Leg] = new c_Base_Node_1D * [1];
          ...
          c_Base_Node_1D ** tmp_Array;
          tmp_Array = new c_Base_Node_1D * [Axon_Count[p_Leg] + 1];
          ...
          //Reallocate the leg to be larger.
          Axons[p_Leg] = new c_Base_Node_1D * [Axon_Count[p_Leg] + 1];
     ...
     void set_Dendrite(int p_Leg, c_Base_Node_1D * p_Node)
     {
          //Set the dendrite.
     ...
     virtual bool does_Lower_Connection_Exist(int p_Leg, c_Base_Node_1D * p_Node)
     {
     ...
     virtual c_Base_Node_1D * does_Upper_Tier_Connection_Exist(c_Base_Node_1D * p_Right)
     {
