...
class c_Num_Bin_Node_Int
{
     friend class c_Num_Bin_Tree_Int; 
     private:
          c_Num_Bin_Node_Int * Right;
          c_Num_Bin_Node_Int * Left;
...
class c_Num_Bin_Tree_Int
{
     private:
             
     public:
          c_Num_Bin_Node_Int * Root;
          c_Num_Bin_Node_Int ** Current;//the current node that will allow referencing outside of the search function
          ...
          void search(int p_Pattern)
          {
               flg_Foundit = false;
               query_Node(Root, p_Pattern);
          }
          
          int query_Node(c_Num_Bin_Node_Int *&p_Node, int p_Pattern)
          {
               if (p_Node == NULL)
               {      
                    p_Node = new c_Num_Bin_Node_Int;
                    p_Node->Right = NULL;
                    p_Node->Left = NULL;
          ...
          int exists(int p_Pattern)
          {
               flg_Foundit = false;
               return exists(Root, p_Pattern);
          }
          
          int exists(c_Num_Bin_Node_Int *&p_Node, int p_Pattern)
          {
               if (p_Node == NULL)
               {      
                    return 0;
          ...
          void output_Node(c_Num_Bin_Node_Int *&p_Node)
          {
          ...
          int get_Node_TRID(c_Num_Bin_Node_Int * &p_Node)
          {
               if (p_Node != NULL)
               {     
                    return p_Node->TRID;      
          ...
          void set_Node_TRID(c_Num_Bin_Node_Int * &p_Node, int p_TRID)
          {
               if (p_Node != NULL)
               {
                    p_Node->TRID = p_TRID;
          ...
          //Reinforces the node.
          void reinforce(c_Num_Bin_Node_Int * &p_Node)
          {
               if (p_Node == NULL){ return; }
          ...
          int get_Reinforcement_Counter(c_Num_Bin_Node_Int * &p_Node)
          {
          ...
          int get_Reinforcement_Counter_Level(c_Num_Bin_Node_Int * &p_Node)
          {
               if (p_Node == NULL){ return 0.0; }
          ...
          float get_RC_Score(c_Num_Bin_Node_Int * &p_Node)
          {
               if (p_Node == NULL){ return 0.0; }
          ...
          float get_RC_Average(c_Num_Bin_Node_Int *&p_Node)
          {
               if (p_Node == NULL){ return 0.0; }
               return get_RC_Average(p_Node->Left) + get_RC_Score(p_Node) + get_RC_Average(p_Node->Right);
          }
          
          //==--     Gets the pattern for the given node.
          
          int get_Node_Pattern(c_Num_Bin_Node_Int *&p_Node)
          {
               if (p_Node == NULL){ return -1; }
               
               return p_Node->Pattern;
          }
};
