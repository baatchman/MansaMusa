...
public:
     ...
     c_Base_Node_Network_1D()
     {
          ...
          Nodes = new c_Base_Node_1D**[1];
          Nodes[0] = new c_Base_Node_1D*[1];
          Nodes[0] [0] = NULL;
     ...
     virtual c_Base_Node_1D * new_Node(int p_Tier, int p_Index)
     {
          ...
          Nodes[p_Tier] [p_Index] = new c_Simple_Node;
     ...
     {
          Nodes[p_Tier] [p_Index] = new c_RC_Node_1D;
     ...
     {
          Nodes[p_Tier] [p_Index] = new c_Treetop_Simple_Node_1D;
     ...
     {
          Nodes[p_Tier] [p_Index] = new c_Treetop_RC_Node_1D;
     ...
     {
          Nodes[0] [*Node_Count[0] - 1] = new c_State_Node_1D;
     ...
     {
          Nodes[0] [p_Index] = new c_RC_State_Node_1D;
     ...
     {
          Nodes[p_Tier] [p_Index] = new c_Treetop_State_Node_1D;
     ...
     {
          Nodes[p_Tier] [p_Index] = new c_Treetop_RC_State_Node_1D;
     ...
     virtual c_Base_Node_1D * new_Node(int p_Tier)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_Simple_Node;
     ...
     virtual c_Base_Node_1D * new_RC_Node(int p_Tier)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_RC_Node_1D;
     ...
     virtual c_Base_Node_1D * new_Treetop_Node(int p_Tier)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_Treetop_Simple_Node_1D;
     ...
     virtual c_Base_Node_1D * new_Treetop_RC_Node(int p_Tier)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_Treetop_RC_Node_1D;
     ...
     virtual c_Base_Node_1D * new_RC_State_Node(u_Data p_State)
     {
          ...
          Nodes[0] [*Node_Count[0] - 1] = new c_RC_State_Node_1D;
     ...
     virtual c_Base_Node_1D * new_Treetop_State_Node(int p_Tier, u_Data p_State)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_Treetop_State_Node_1D;
     ...
     virtual c_Base_Node_1D * new_Treetop_RC_State_Node(int p_Tier, u_Data p_State)
     {
          ...
          Nodes[p_Tier] [*Node_Count[p_Tier] - 1] = new c_Treetop_RC_State_Node_1D;
     ...
     */
     ...
     void increase_Number_Of_Tiers(int p_Tier)
     {
          ...
          c_Base_Node_1D *** tmp_Nodes = new c_Base_Node_1D ** [Number_Of_Tiers];
          ...
          for (int cou_T=0;cou_T<Number_Of_Tiers;cou_T++)
          {
               ...
               tmp_Nodes[cou_T] = new c_Base_Node_1D * [*Node_Count[cou_T]];
          ...
          for (int cou_T=Number_Of_Tiers;cou_T<p_Tier;cou_T++)
          {
               Nodes[cou_T] = new c_Base_Node_1D * [1];
               Nodes[cou_T] [0] = NULL;
          }
     ...
     void increase_Number_Of_Nodes_On_Tier(int p_Tier, int p_Index)
     {
          ...
          *Node_Count_MAX[p_Tier] += (int (*Node_Count_MAX[p_Tier] * .75) + 1);
          ...
          if (*Node_Count[p_Tier] == 0)
          {
               ...
               Nodes[p_Tier] = new c_Base_Node_1D * [p_Index];
          ...
          c_Base_Node_1D ** tmp_Tier;
          tmp_Tier = new c_Base_Node_1D * [*Node_Count[p_Tier]];
          ...
          Nodes[p_Tier] = new c_Base_Node_1D * [*Node_Count_MAX[p_Tier]];
     ...
     void increment_Number_Of_Nodes_On_Tier(int p_Tier)
     {
          ...
          if (*Node_Count[p_Tier] == 0)
          {
               ...
               Nodes[p_Tier] = new c_Base_Node_1D * [1];
               Nodes[p_Tier] [0] = NULL;
          ...
          Nodes[p_Tier] = new c_Base_Node_1D * [*Node_Count[p_Tier] + 1];
