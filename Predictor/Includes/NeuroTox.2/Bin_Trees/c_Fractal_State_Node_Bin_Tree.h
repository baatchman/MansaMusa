...
class c_Fractal_State_Bin_Node
{
     friend class c_Fractal_State_Bin_Tree; 
     private:
          c_Fractal_State_Bin_Node * Right;
          c_Fractal_State_Bin_Node * Center;
          c_Fractal_State_Bin_Node * Left;
          
     public:
          u_Data Data;
          c_Base_Node_1D * NID;
          
          c_Fractal_State_Bin_Node()
          {
               Right = NULL;
               Center = NULL;
               Left = NULL;
...
class c_Fractal_State_Bin_Tree
{
private:
             
             
     public:
          c_Fractal_State_Bin_Node * Root;
          c_Fractal_State_Bin_Node ** Current;//the current node that will allow referencing outside of the search function
          bool flg_Foundit;//the flag that set when a node is found already set
          u_Data tmp_Data;
          
          c_Fractal_State_Bin_Tree()
          {
               Root = NULL;
               Current = NULL;
               flg_Foundit = false;
          ...
          int query_Node(c_Fractal_State_Bin_Node *&p_Node, u_Data p_Data, int p_Fractal)
          {
               ...
               {      
                    //cout << "\n\t   Node is NULL";
                    p_Node = new c_Fractal_State_Bin_Node;
                    p_Node->Right = NULL;
                    p_Node->Center = NULL;
                    p_Node->Left = NULL;
                    p_Node->NID = NULL;
          ...
          int query_Node_Verbose(c_Fractal_State_Bin_Node *&p_Node, u_Data p_Data, int p_Fractal)
          {
               tmp_Data.I = int (p_Data.I / p_Fractal);// - (p_Data.I / (p_Fractal * 10));
          ...
          c_Base_Node_1D * get_NID(u_Data p_Data, int p_Fractal = 10000000)
          {
               return query_For_NID(Root, p_Data, p_Fractal);
          }
          
          c_Base_Node_1D * query_For_NID(c_Fractal_State_Bin_Node *&p_Node, u_Data p_Data, int p_Fractal)
          {
          ...
          void output_Node(c_Fractal_State_Bin_Node *&p_Node, int p_Tab)
          {
          ...
          c_Base_Node_1D * get_Node_NID(c_Fractal_State_Bin_Node * &p_Node)
          {
               if (p_Node != NULL){     
                    return p_Node->NID;      
                    } else {
          ...
          void set_Node_NID(c_Fractal_State_Bin_Node * &p_Node, c_Base_Node_1D * p_NID)
          {
               if (p_Node != NULL)
               {
                    p_Node->NID = p_NID;
