...
public:
     ...
     c_Shipyard_Line_Graph(string p_Name)
     {
          Name = p_Name;
          Data = NULL;
          Data_Set_Name = NULL;
	...
	//Gets the name.
     ...
     void submit_Data_Set_Name(int p_Data_Set, string p_Name)
     {
          ...
          for (int cou_Index=0;cou_Index<Number_Of_Data_Sets;cou_Index++)
          {
               ...
               for (int cou_D=0;cou_D<Data_Set_Depth;cou_D++)
               {
                    ...
                    if (cou_D)
                    {
                         ...
                         string tmp_Value = float2str(Data[cou_Index] [cou_D]);
     ...
     void increase_Number_Of_Data_Sets(int p_Depth)
     {
          ...
          string * tmp_Name;
          tmp_Name = new string[Number_Of_Data_Sets];
          ...
          Data_Set_Name = new string[p_Depth];
