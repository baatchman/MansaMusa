...
class c_NT3_Linked_List_NonStrict_MMap
{
public:
     
     //The next node in the chain.
     c_NT3_Linked_List_NonStrict_MMap * Next;
     c_NT3_Linked_List_NonStrict_MMap * Previous;
     u_Data_3 Charge;
     c_NT3_Base_Node_NonStrict_MMap * NID;
     
     c_NT3_Linked_List_NonStrict_MMap()
     {
          Next = NULL;
          Previous = NULL;
          Charge.I = 0;
...
class c_NT3_Linked_List_NonStrict_Handler_MMap
{
public:
     
     //The nodes in the linked list.
     c_NT3_Linked_List_NonStrict_MMap * Root;
     c_NT3_Linked_List_NonStrict_MMap ** Current_LL;
     long long int Depth;
     
     c_NT3_Linked_List_NonStrict_Handler_MMap()
     {
          Root = NULL;
          Current_LL = &Root;
          Depth = 0;
     ...
     //Adds a node.
     c_NT3_Linked_List_NonStrict_MMap * new_LL(c_NT3_Base_Node_NonStrict_MMap * p_NID, long long int p_Charge)
     {
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL = NULL;
          
          *Current_LL = new c_NT3_Linked_List_NonStrict_MMap;
     ...
     void reset()
     {
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL = Root;
          Root = NULL;
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL_Next = NULL;
     ...
     {
          //Tmp vars
          c_NT3_Linked_List_NonStrict_MMap * tmp_Prv = NULL;
          c_NT3_Linked_List_NonStrict_MMap * tmp_Next = NULL;
          c_NT3_Linked_List_NonStrict_MMap * tmp_Current = NULL;
          bool flg_Done = false;
...
class c_NT3_Buffer_NonStrict_Node_NonStrict_MMap
{
     friend class c_NT3_Buffer_NonStrict_Tree_NonStrict_MMap; 
     private:
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * Right;
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * Center;
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * Left;
          
     public:
          u_Data_3 Data;
          
          c_NT3_Linked_List_NonStrict_MMap * LL;
          
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap()
          {
               Right = NULL;
               Center = NULL;
               Left = NULL;
...
class c_NT3_Buffer_NonStrict_Tree_NonStrict_MMap
{
private:
             
             
     public:
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * Root;
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap ** Current;//the current node that will allow referencing outside of the search function
          ...
          c_NT3_Buffer_NonStrict_Tree_NonStrict_MMap()
          {
               Root = NULL;
               Current = NULL;
               flg_Foundit = false;
          ...
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * search(c_NT3_Base_Node_NonStrict_MMap * p_Data)
          {
               flg_Foundit = false;
          ...
          c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * query_Node(c_NT3_Buffer_NonStrict_Node_NonStrict_MMap *&p_Node, u_Data_3 p_Data, int p_Shift)
          {
               //These are used because we have to be carefull not to leave Mutex locked with a return.
               c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * tmp_Return = NULL;
               bool flg_Done = false;
               ...
               {      
                    //--cout << "\n\t   Node is NULL";
                    p_Node = new c_NT3_Buffer_NonStrict_Node_NonStrict_MMap;
                    p_Node->Right = NULL;
                    p_Node->Center = NULL;
                    p_Node->Left = NULL;
                    if (p_Shift > 1)
          ...
          void output_Node(c_NT3_Buffer_NonStrict_Node_NonStrict_MMap *&p_Node, int p_Tab)
          {
          ...
          c_NT3_Linked_List_NonStrict_MMap * get_Node_LL(c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * &p_Node)
          {
               if (p_Node != NULL){     
                    return p_Node->LL;      
                    } else {
          ...
          void set_Node_LL(c_NT3_Buffer_NonStrict_Node_NonStrict_MMap * &p_Node, c_NT3_Linked_List_NonStrict_MMap * p_LL)
          {
               if (p_Node != NULL)
               {
                    p_Node->LL = p_LL;
          ...
          c_NT3_Linked_List_NonStrict_MMap * set_Current_Node_LL(c_NT3_Linked_List_NonStrict_MMap * p_LL)
          {
               set_Node_LL(*Current, p_LL);
               return p_LL;
          }
          
          c_NT3_Linked_List_NonStrict_MMap * get_Current_Node_LL()
          {
...
class c_NT3_Buffer_NonStrict_MMap
{
private:
...
public:
     ...
     //The search tree.
     c_NT3_Buffer_NonStrict_Tree_NonStrict_MMap Tree;
     
     //The linked lists.
     c_NT3_Linked_List_NonStrict_Handler_MMap Current_Charge;
     
     c_NT3_Linked_List_NonStrict_Handler_MMap Output;
     
     c_NT3_Linked_List_NonStrict_Handler_MMap Treetops;
     ...
     {
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL = Output.Root;
     ...
     void submit(c_NT3_Base_Node_NonStrict_MMap * p_Node, long long int p_Charge = 10000)
     {
          //Search for the submitted node, if found add the charge.
          if ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref != NULL)
          {
               ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref)->Charge.I += p_Charge;
               if (((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref)->Charge.I > Current_Highest_Charge){ Current_Highest_Charge = ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref)->Charge.I; }
          }
          
          if ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref == NULL && p_Node != NULL)
          {
     ...
     //Accepts a submission of nodes to charge, used for CAN.
     void submit_RC(c_NT3_Base_Node_NonStrict_MMap * p_Node, long long int p_Charge = 10000)
     {
          
          //Search for the submitted node, if found add the charge.
          if ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref != NULL)
          {
               ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref)->Charge.I += (p_Charge * ((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref)->NID->get_RC_Score());
          ...
          if (((c_NT3_Linked_List_NonStrict_MMap*) p_Node->Ref) == NULL && p_Node != NULL)
          {
               ...
               p_Node->Ref = Current_Charge.new_LL(p_Node, __int64 (p_Node->get_RC_Score() * p_Charge));
          }
     }
     ...
     {
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL = Treetops.Root;
          c_NT3_Linked_List_NonStrict_MMap * tmp_LL_Root = Treetops.Root;
          ...
          while(tmp_LL != NULL)
          {
               ...
               tmp_Charge = __int64 (((tmp_LL->Charge.I * Modifier_Charge) / tmp_Current_Highest_Charge) * Base_Charge);
