...
//The construct class.
class c_NT3_Construct_MMap_2D: public c_NT3_Base_Construct
{
private:
...
public:
     ...
     ~c_NT3_Construct_MMap_2D()
     {
          cout << "\n  ~c_NT3_Construct_MMap_2D " << Name << " " << this << ".........."; cout.flush();
     ...
     c_Raw_Table_1D * get_Table_1D(string p_Table){ return NULL; }
     c_Raw_Table_2D * get_Table_2D(string p_Table){ return NULL; }
     ...
     void Eval_RC()
     {
          //cout << "\n c_NT3_Construct_MMap_2D::Eval_RC()";
     ...
     {
          //cout << "\n c_NT3_Construct_MMap_2D::charge_Buffer_C()";
     ...
     {
          //cout << "\n c_NT3_Construct_MMap_2D::charge_Buffer_RC_C()";
