...
public:
     ...
     void resize_Position(int p_Tier, int p_Position, int p_Size)
     {
          ...
          //Setup the tmp vars.
          c_NT3_Base_Node_1D ** tmp_Nodes;
          tmp_Nodes = new c_NT3_Base_Node_1D*[Number_Of_Nodes[p_Tier] [p_Position]];
          ...
          CAN[p_Tier] [p_Position] = new c_NT3_Base_Node_1D*[tmp_MAX];
