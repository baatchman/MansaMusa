...
public:
     ...
     void query_State()
     {
          for (int cou_Position=0;cou_Position<Number_Of_Tiers;cou_Position++)
          {
               ...
               {
                    CAN[0] [cou_Position] [cou_Index]->U = Nodes->get_State_Node_Query(Input->Cells[cou_Position]->Data[cou_Index]);
               }
          }
     }
     ...
     {
          c_NT3_Base_Node_MMap_1D * tmp_Node = NULL;
     ...
     void resize()
     {
          ...
          //Setup the tiers.
          CAN = new c_NT3_Base_Node_MMap_1D***[Number_Of_Tiers];
          ...
          for (int cou_T=0;cou_T<Number_Of_Tiers;cou_T++)
          {
               CAN[cou_T] = new c_NT3_Base_Node_MMap_1D**[(Number_Of_Tiers - cou_T)];
     ...
     void resize_Position(int p_Tier, int p_Position, int p_Size)
     {
          ...
          //Setup the tmp vars.
          c_NT3_Base_Node_MMap_1D ** tmp_Nodes;
          tmp_Nodes = new c_NT3_Base_Node_MMap_1D*[Number_Of_Nodes[p_Tier] [p_Position]];
          ...
          CAN[p_Tier] [p_Position] = new c_NT3_Base_Node_MMap_1D*[tmp_MAX];
