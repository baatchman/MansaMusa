...
public:
     ...
     string save_Realm(int * p_EIP, c_Lookup_Tree * p_Labels, c_Table_1D * p_Tokens)
     {
          ...
          string tmp_DIR = "NT3.Save/CMD.Save/" + tmp_Token[1] + "/";
          
          string tmp_MD = "md \"" + tmp_DIR + "\"";
          cout << "\n system:"; ostr(0, 12, tmp_MD);
          system(tmp_MD.c_str());
          
          Sandbox.Save(tmp_DIR, tmp_Token[1]);
     ...
     string load_Realm(int * p_EIP, c_Lookup_Tree * p_Labels, c_Table_1D * p_Tokens)
     {
          ...
          if (tmp_Token[1] == "list"){ cout << "\n\n\nDIRRRR"; system("DIR \"NT3.Save\\CMD.Save\\\""); return "COMMAND_PARSER->SAVE_COMMAND_DIR_SAVES"; }
          
          string tmp_DIRName = "NT3.Save/CMD.Save/" + tmp_Token[1] + "/";
          ...
          Sandbox.Load(tmp_DIRName, tmp_Realm);
