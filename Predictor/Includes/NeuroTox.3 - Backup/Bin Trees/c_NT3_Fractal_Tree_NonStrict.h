...
class c_NT3_Fractal_State_Node_NonStrict
{
     friend class c_NT3_Fractal_State_Tree_NonStrict; 
     private:
          c_NT3_Fractal_State_Node_NonStrict * Right;
          c_NT3_Fractal_State_Node_NonStrict * Center;
          c_NT3_Fractal_State_Node_NonStrict * Left;
          
     public:
          u_Data_3 Data;
          c_NT3_Base_Node_NonStrict * NID;
          
          c_NT3_Fractal_State_Node_NonStrict()
          {
               Right = NULL;
               Center = NULL;
               Left = NULL;
...
class c_NT3_Fractal_State_Tree_NonStrict
{
private:
             
             
     public:
          c_NT3_Fractal_State_Node_NonStrict * Root;
          c_NT3_Fractal_State_Node_NonStrict ** Current;//the current node that will allow referencing outside of the search function
          bool flg_Foundit;//the flag that set when a node is found already set
          u_Data_3 tmp_Data;
          
          c_NT3_Fractal_State_Tree_NonStrict()
          {
               Root = NULL;
               Current = NULL;
               flg_Foundit = false;
          ...
          int query_Node(c_NT3_Fractal_State_Node_NonStrict *&p_Node, u_Data_3 p_Data, int p_Shift)
          {
               ...
               {      
                    //*cout << "\n\t   Node is NULL";
                    p_Node = new c_NT3_Fractal_State_Node_NonStrict;
                    p_Node->Right = NULL;
                    p_Node->Center = NULL;
                    p_Node->Left = NULL;
                    p_Node->NID = NULL;
          ...
          void output_Node(c_NT3_Fractal_State_Node_NonStrict *&p_Node, int p_Tab)
          {
          ...
          void output_Node_BP(c_NT3_Fractal_State_Node_NonStrict *&p_Node)
          {
               if (p_Node == NULL){ return; }
          ...
          c_NT3_Base_Node_NonStrict * get_Node_NID(c_NT3_Fractal_State_Node_NonStrict * &p_Node)
          {
               if (p_Node != NULL){     
                    return p_Node->NID;      
                    } else {
          ...
          void set_Node_NID(c_NT3_Fractal_State_Node_NonStrict * &p_Node, c_NT3_Base_Node_NonStrict * p_NID)
          {
               if (p_Node != NULL)
               {
                    p_Node->NID = p_NID;
          ...
          c_NT3_Base_Node_NonStrict * set_Current_Node_NID(c_NT3_Base_Node_NonStrict * p_NID)
          {
               set_Node_NID(*Current, p_NID);
               return p_NID;
          }
          
          c_NT3_Base_Node_NonStrict * get_Current_Node_NID()
          {
