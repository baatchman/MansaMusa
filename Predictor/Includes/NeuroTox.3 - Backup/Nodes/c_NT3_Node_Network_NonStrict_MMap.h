...
class c_NT3_Node_Network_NonStrict_MMap
{
private:
...
public:
     ...
     c_NT3_Base_Node_NonStrict_MMap * Root;
     
     //The current node to attach to.
     c_NT3_Base_Node_NonStrict_MMap ** Current_Node;
     
     //The Fractional tree for handling state queries.
     c_NT3_Fractal_State_Tree_NonStrict_MMap State_Tree;
     
     //The tree to hold the Treetops for backpropagation.
     c_NT3_Fractal_State_Tree_NonStrict_MMap Treetops_Tree;
     ...
     c_NT3_Fractal_State_Tree_NonStrict_MMap NID_Tree;
     
     c_NT3_Node_Network_NonStrict_MMap()
     {
          CNID.I = 0;
          Root = NULL;
          Current_Node = &Root;
     ...
     ~c_NT3_Node_Network_NonStrict_MMap()
     {
          cout << "\n ~c_NT3_Node_Network_NonStrict_MMap " << CNID.I << " " << this << ".........."; cout.flush();
          //delete Root;
          
          c_NT3_Base_Node_NonStrict_MMap * tmp_LL = Root;
          Root = NULL;
          c_NT3_Base_Node_NonStrict_MMap * tmp_LL_Next = NULL;
     ...
     c_NT3_Base_Node_NonStrict_MMap * new_State_Node(u_Data_3 p_State, int p_D = 0, int p_A = 0)
     {
          //Create the state node.
          *Current_Node = new c_NT3_State_Node_NonStrict_MMap;
     ...
     //Creates a new node.
     c_NT3_Base_Node_NonStrict_MMap * new_Node(int p_D = 0, int p_A = 0)
     {
          //A tmp Node because we iterate the Current_Node.
          c_NT3_Base_Node_NonStrict_MMap * tmp_Return_Node;
          
          //Create the state node.
          *Current_Node = new c_NT3_Node_NonStrict_MMap;
     ...
     void convert_To_Treetop_Node(c_NT3_Base_Node_NonStrict_MMap * p_Node)
     {
     ...
     void create_Connection(c_NT3_Base_Node_NonStrict_MMap * p_From, c_NT3_Base_Node_NonStrict_MMap * p_To)
     {
     ...
     //Creates a connection from p_From to p_To.
     void create_Predefined_Connection(c_NT3_Base_Node_NonStrict_MMap * p_From, c_NT3_Base_Node_NonStrict_MMap * p_To)
     {
     ...
     c_NT3_Base_Node_NonStrict_MMap * does_Upper_Tier_Connection_Exist(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)
     {
     ...
     c_NT3_Base_Node_NonStrict_MMap * assign_State_Node(u_Data_3 p_State, c_NT3_Base_Node_NonStrict_MMap * p_Node, int p_A_L = 0, int p_A_R = 0)
     {
          //Search for the node.
     ...
     //Get a state node.
     c_NT3_Base_Node_NonStrict_MMap * get_State_Node(u_Data_3 p_State, int p_A_L = 0, int p_A_R = 0)
     {
          //Search for the node.
          State_Tree.search(p_State);
     ...
     c_NT3_Base_Node_NonStrict_MMap * get_State_Node_Query(u_Data_3 p_State)
     {
          //Search for the node.
          State_Tree.search(p_State);
     ...
     c_NT3_Base_Node_NonStrict_MMap * get_Upper_Tier_Connection(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)
     {
          //A tmp var to hold the upper tier node for returning.
          c_NT3_Base_Node_NonStrict_MMap * tmp_Node = NULL;
     ...
     c_NT3_Base_Node_NonStrict_MMap * get_Treetop_Connection(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)
     {
          c_NT3_Base_Node_NonStrict_MMap * tmp_Node = get_Upper_Tier_Connection(p_Nodes, p_Node_Count);
     ...
     void bp_Output_Only(c_NT3_Base_Node_NonStrict_MMap * p_Node, int p_Type = 0)
     {
     ...
     void bp_Output_Only_Lower(c_NT3_Base_Node_NonStrict_MMap * p_Node, int p_Type)
     {
          char tmp_State = ' ';
     ...
     //Starts the Backprop procedures for output only.
     void bp(c_Raw_Table_1D * p_Pattern_Output, int p_Input, c_NT3_Base_Node_NonStrict_MMap * p_Node)
     {
          //For when directly output the dendrites of a nodes on the base tier.
          if (p_Node == NULL){ return; }
     ...
     //bp_Output the left node.
     void bp_Lower(c_Raw_Table_1D * p_Pattern_Output, int p_Input, c_NT3_Base_Node_NonStrict_MMap * p_Node)
     {
          //If a left leg exists then initiate a backpropagation along it, then along the right side.
          if (p_Node->Dendrite_Count > 0)
          {
     ...
     c_NT3_Base_Node_NonStrict_MMap * bp_Treetop(c_Raw_Table_1D * p_Pattern_Output, int p_Input, u_Data_3 p_NID)
     {
          c_NT3_Base_Node_NonStrict_MMap * tmp_Node = NULL;
     ...
     void save(ofstream * p_SF)
     {
          ...
          *p_SF << "\nNode_Count " << CNID.U;
          ...
          c_NT3_Base_Node_NonStrict_MMap * tmp_Node = Root;
     ...
     void load(ifstream * p_LF)
     {
          ...
          //The new scaffold.
          c_NT3_Base_Node_NonStrict_MMap ** tmp_NScaffold = NULL;
          ...
          *p_LF >> Node_Count.U;
          ...
          tmp_NScaffold = new c_NT3_Base_Node_NonStrict_MMap*[Node_Count.U];
