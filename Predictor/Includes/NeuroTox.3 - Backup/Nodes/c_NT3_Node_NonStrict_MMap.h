...
class c_NT3_Base_Node_NonStrict_MMap
{
public:
     
     virtual ~c_NT3_Base_Node_NonStrict_MMap(){};
     
     //The ID of this node.
     u_Data_3 NID;
     
     //The next node in the Linked List.
     c_NT3_Base_Node_NonStrict_MMap * Next;
     
     //Axons and their counters.
     c_NT3_Base_Node_NonStrict_MMap ** Axons;
     int Axon_Count;
     
     //Dendrites and their counters.
     c_NT3_Base_Node_NonStrict_MMap ** Dendrites;
     int Dendrite_Count;
     ...
     //Member Functions.
     virtual void add_Axon(c_NT3_Base_Node_NonStrict_MMap * p_Axon)=0; //Adds an axon
     
     virtual void add_Predefined_Axon(c_NT3_Base_Node_NonStrict_MMap * p_Axon)=0; //Adds an axon to the 
     
     virtual void add_Predefined_Dendrite(c_NT3_Base_Node_NonStrict_MMap * p_Dendrite)=0; //Adds an axon to the 
     ...
     virtual c_NT3_Base_Node_NonStrict_MMap * does_Upper_Tier_Connection_Exist(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)=0;//Searches the axons to see if an upper tier connection exists on the left leg.
     
     virtual bool does_Lower_Connection_Exist(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)=0; //Checks if the given nodes match the dendrites, not just in address but in position.
     
     virtual void add_Dendrite(c_NT3_Base_Node_NonStrict_MMap * p_Dendrite)=0; //Sets the left dendrite to the given dendrite.
...
class c_NT3_Node_NonStrict_MMap: public c_NT3_Base_Node_NonStrict_MMap
{
public:
     
     c_NT3_Node_NonStrict_MMap()
     {
          //The next node.
          Next = NULL;
     ...
     {
          /*
          cout << "\n   ~c_NT3_Node_NonStrict_MMap " << this << " NID->" << NID.U; cout.flush();
     ...
     void add_Axon(c_NT3_Base_Node_NonStrict_MMap * p_Axon)
     {
          c_NT3_Base_Node_NonStrict_MMap ** tmp_Axons;
          tmp_Axons = new c_NT3_Base_Node_NonStrict_MMap*[Axon_Count];
          ...
          Axons = new c_NT3_Base_Node_NonStrict_MMap*[Axon_Count + 1]; 
     ...
     void add_Predefined_Axon(c_NT3_Base_Node_NonStrict_MMap * p_Axon)
     {
          Axons[Axon_Count] = p_Axon; 
          Axon_Count++;
     }
     ...
     //Adds an axon on the left leg.
     void add_Dendrite(c_NT3_Base_Node_NonStrict_MMap * p_Dendrite)
     {
          c_NT3_Base_Node_NonStrict_MMap ** tmp_Dendrites;
          tmp_Dendrites = new c_NT3_Base_Node_NonStrict_MMap*[Dendrite_Count];
          ...
          Dendrites = new c_NT3_Base_Node_NonStrict_MMap*[Dendrite_Count + 1]; 
     ...
     //Adds an axon connection to the given index, it assumes the array is already defined and will not overbound.
     void add_Predefined_Dendrite(c_NT3_Base_Node_NonStrict_MMap * p_Dendrite)
     {
          Dendrites[Dendrite_Count] = p_Dendrite; 
          Dendrite_Count++;
     }
     ...
     void expand_Axon(int p_Count)
     {
          ...
          Axons = new c_NT3_Base_Node_NonStrict_MMap*[p_Count]; 
     ...
     void expand_Dendrite(int p_Count)
     {
          ...
          Dendrites = new c_NT3_Base_Node_NonStrict_MMap*[p_Count]; 
     ...
     bool does_Lower_Connection_Exist(c_NT3_Base_Node_NonStrict_MMap ** p_Nodes, int p_Node_Count)
     { 
...
//State node.
class c_NT3_State_Node_NonStrict_MMap: public c_NT3_Base_Node_NonStrict_MMap
{
private:
...
public:
     ...
     c_NT3_State_Node_NonStrict_MMap()
     {
          State.I = 0;
     ...
     ~c_NT3_State_Node_NonStrict_MMap()
     {
          //cout << " ~c_NT3_State_Node_NonStrict_MMap " << this << " NID->" << NID.U; cout.flush();
