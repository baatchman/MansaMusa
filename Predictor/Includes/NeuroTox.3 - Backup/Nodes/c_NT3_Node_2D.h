...
class c_NT3_Base_Node_2D
{
public:
     
     virtual ~c_NT3_Base_Node_2D(){};
     
     //The ID of this node.
     u_Data_3 NID;
     
     //The next node in the Linked List.
     c_NT3_Base_Node_2D * Next;
     
     //Axons and their counters.
     c_NT3_Base_Node_2D ** Axons_0;
     int Axon_Count_0;
     
     c_NT3_Base_Node_2D ** Axons_1;
     int Axon_Count_1;
     
     c_NT3_Base_Node_2D ** Axons_2;
     int Axon_Count_2;
     
     c_NT3_Base_Node_2D ** Axons_3;
     int Axon_Count_3;
     
     //Dendrites.
     c_NT3_Base_Node_2D * Dendrite_0;
     c_NT3_Base_Node_2D * Dendrite_1;
     c_NT3_Base_Node_2D * Dendrite_2;
     c_NT3_Base_Node_2D * Dendrite_3;
     ...
     //Member Functions.
     virtual void add_Axon_0(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Axon_1(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Axon_2(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Axon_3(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     
     virtual void add_Predefined_Axon_0(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Predefined_Axon_1(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Predefined_Axon_2(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     virtual void add_Predefined_Axon_3(c_NT3_Base_Node_2D * p_Axon)=0; //Adds an axon on the  leg.
     ...
     virtual c_NT3_Base_Node_2D * does_Upper_Tier_Connection_Exist(c_NT3_Base_Node_2D * p_Node[4])=0;//Searches the axons to see if an upper tier connection exists on the left leg.
     
     virtual bool does_Lower_Connection_Exist_L0(c_NT3_Base_Node_2D * p_Node)=0; //Checks if the given node matches a dendrite on the  leg.
     virtual bool does_Lower_Connection_Exist_L1(c_NT3_Base_Node_2D * p_Node)=0; //Checks if the given node matches a dendrite on the  leg.
     virtual bool does_Lower_Connection_Exist_L2(c_NT3_Base_Node_2D * p_Node)=0; //Checks if the given node matches a dendrite on the  leg.
     virtual bool does_Lower_Connection_Exist_L3(c_NT3_Base_Node_2D * p_Node)=0; //Checks if the given node matches a dendrite on the  leg.
     
     virtual void set_Dendrite_0(c_NT3_Base_Node_2D * p_Dendrite)=0; //Sets the  dendrite to the given dendrite.
     virtual void set_Dendrite_1(c_NT3_Base_Node_2D * p_Dendrite)=0; //Sets the  dendrite to the given dendrite.
     virtual void set_Dendrite_2(c_NT3_Base_Node_2D * p_Dendrite)=0; //Sets the  dendrite to the given dendrite.
     virtual void set_Dendrite_3(c_NT3_Base_Node_2D * p_Dendrite)=0; //Sets the  dendrite to the given dendrite.
...
class c_NT3_Node_2D: public c_NT3_Base_Node_2D
{
public:
     ...
     {
          /*
          cout << "\n   ~c_NT3_Node_2D " << this << " NID->" << NID.U; cout.flush();
     ...
     void add_Axon_0(c_NT3_Base_Node_2D * p_Axon)
     {
          c_NT3_Base_Node_2D ** tmp_Axons;
          tmp_Axons = new c_NT3_Base_Node_2D*[Axon_Count_0];
          ...
          Axons_0 = new c_NT3_Base_Node_2D*[Axon_Count_0 + 1]; 
     ...
     //Adds an axon on the left leg.
     void add_Axon_1(c_NT3_Base_Node_2D * p_Axon)
     {
          c_NT3_Base_Node_2D ** tmp_Axons;
          tmp_Axons = new c_NT3_Base_Node_2D*[Axon_Count_1];
          ...
          Axons_1 = new c_NT3_Base_Node_2D*[Axon_Count_1 + 1]; 
     ...
     //Adds an axon on the left leg.
     void add_Axon_2(c_NT3_Base_Node_2D * p_Axon)
     {
          c_NT3_Base_Node_2D ** tmp_Axons;
          tmp_Axons = new c_NT3_Base_Node_2D*[Axon_Count_2];
          ...
          Axons_2 = new c_NT3_Base_Node_2D*[Axon_Count_2 + 1]; 
     ...
     //Adds an axon on the left leg.
     void add_Axon_3(c_NT3_Base_Node_2D * p_Axon)
     {
          c_NT3_Base_Node_2D ** tmp_Axons;
          tmp_Axons = new c_NT3_Base_Node_2D*[Axon_Count_3];
          ...
          Axons_3 = new c_NT3_Base_Node_2D*[Axon_Count_3 + 1]; 
     ...
     void add_Predefined_Axon_0(c_NT3_Base_Node_2D * p_Axon)
     {
          Axons_0[Axon_Count_0] = p_Axon; 
          Axon_Count_0++;
     }
     ...
     //Adds an axon connection to the given index, it assumes the array is already defined and will not overbound.
     void add_Predefined_Axon_1(c_NT3_Base_Node_2D * p_Axon)
     {
          Axons_1[Axon_Count_1] = p_Axon; 
          Axon_Count_1++;
     }
     ...
     //Adds an axon connection to the given index, it assumes the array is already defined and will not overbound.
     void add_Predefined_Axon_2(c_NT3_Base_Node_2D * p_Axon)
     {
          Axons_2[Axon_Count_2] = p_Axon; 
          Axon_Count_2++;
     }
     ...
     //Adds an axon connection to the given index, it assumes the array is already defined and will not overbound.
     void add_Predefined_Axon_3(c_NT3_Base_Node_2D * p_Axon)
     {
          Axons_3[Axon_Count_3] = p_Axon; 
          Axon_Count_3++;
     }
     ...
     void expand_Axon_0(int p_Count)
     {
          ...
          Axons_0 = new c_NT3_Base_Node_2D*[p_Count]; 
     ...
     void expand_Axon_1(int p_Count)
     {
          ...
          Axons_1 = new c_NT3_Base_Node_2D*[p_Count]; 
     ...
     void expand_Axon_2(int p_Count)
     {
          ...
          Axons_2 = new c_NT3_Base_Node_2D*[p_Count]; 
     ...
     void expand_Axon_3(int p_Count)
     {
          ...
          Axons_3 = new c_NT3_Base_Node_2D*[p_Count]; 
     ...
     c_NT3_Base_Node_2D * does_Upper_Tier_Connection_Exist(c_NT3_Base_Node_2D * p_Node[4])
     {
     ...
     bool does_Lower_Connection_Exist_L0(c_NT3_Base_Node_2D * p_Node)
     { 
     ...
     //Checks if the given node matches a dendrite on the left leg.
     bool does_Lower_Connection_Exist_L1(c_NT3_Base_Node_2D * p_Node)
     { 
     ...
     //Checks if the given node matches a dendrite on the left leg.
     bool does_Lower_Connection_Exist_L2(c_NT3_Base_Node_2D * p_Node)
     { 
     ...
     //Checks if the given node matches a dendrite on the left leg.
     bool does_Lower_Connection_Exist_L3(c_NT3_Base_Node_2D * p_Node)
     { 
     ...
     void set_Dendrite_0(c_NT3_Base_Node_2D * p_Dendrite)
     {
          Dendrite_0 = p_Dendrite;
     }
     
     //Sets the left dendrite to the given dendrite.
     void set_Dendrite_1(c_NT3_Base_Node_2D * p_Dendrite)
     {
          Dendrite_1 = p_Dendrite;
     }
     
     //Sets the left dendrite to the given dendrite.
     void set_Dendrite_2(c_NT3_Base_Node_2D * p_Dendrite)
     {
          Dendrite_2 = p_Dendrite;
     }
     
     //Sets the left dendrite to the given dendrite.
     void set_Dendrite_3(c_NT3_Base_Node_2D * p_Dendrite)
     {
...
//State node.
class c_NT3_State_Node_2D: public c_NT3_Base_Node_2D
{
private:
...
public:
     ...
     ~c_NT3_State_Node_2D()
     {
          //cout << " ~c_NT3_State_Node_2D " << this << " NID->" << NID.U; cout.flush();
          if (Axons_0 != NULL)
          {
               for (int cou_Index=0;cou_Index<Axon_Count_0;cou_Index++)
               {
