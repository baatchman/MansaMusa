...
public:
     ...
     void extract()
     {
          ...
          //Axons and their counters.
          Axon_Count_L = *reinterpret_cast<unsigned long long int*> (tmp_Data + tmp_Offset);
          tmp_Offset += sizeof(Axon_Count_L);
...
public:
     ...
     void resize_Axon_List_L(unsigned long int p_Size)
     {
          if (Axon_List_L != NULL){ delete Axon_List_L; Axon_List_L = NULL; }
     ...
     void goto_Axon_Block_L(unsigned long long int p_Axon_Block, long int p_Axon_Count)
     {
          ...
          *p_SF << "\n";
          ...
          else
          {
               ...
               *p_SF << "\nctx.stroke();";
               ...
               //Get Coords of dendrites to link them.
               tmp_DL = current_Node.Dendrite_L.U;
               tmp_DR = current_Node.Dendrite_R.U;
